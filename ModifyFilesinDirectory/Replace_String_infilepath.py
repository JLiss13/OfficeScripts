...
Folder=input("What directory are you working in?") # Must input a string with apostrophes
print(Folder)
Old_string=input("What strings of filename do you want to replace?")
print(Old_string)
New_string=input("What do you want the old string to be replaced with?")
print(New_string)
